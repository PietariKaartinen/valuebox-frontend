          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li><Link href="/shop/best-gifts" className="text-sm text-gray-500 hover:text-accent transition-colors">Best Gifts</Link></li>
                <li><Link href="/shop/todays-deals" className="text-sm text-gray-500 hover:text-accent transition-colors">Today&apos;s Deals</Link></li>
                <li><Link href="/shop/under-25" className="text-sm text-gray-500 hover:text-accent transition-colors">Under $25</Link></li>
                <li><Link href="/shop/featured" className="text-sm text-gray-500 hover:text-accent transition-colors">Featured</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li><Link href="/premium" className="text-sm text-gray-500 hover:text-accent transition-colors">Manage Membership</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {/* TODO: replace with real page once built */}
                <li><Link href="/support" className="text-sm text-gray-500 hover:text-accent transition-colors">About</Link></li>
                {/* TODO: replace with real page once built */}
                <li><Link href="/support" className="text-sm text-gray-500 hover:text-accent transition-colors">Partnerships</Link></li>
                {/* TODO: replace with real page once built */}
                <li><Link href="/support" className="text-sm text-gray-500 hover:text-accent transition-colors">Careers</Link></li>
                {/* TODO: replace with real page once built */}
                <li><Link href="/support" className="text-sm text-gray-500 hover:text-accent transition-colors">Press</Link></li>
                {/* TODO: replace with real page once built */}
                <li><Link href="/support" className="text-sm text-gray-500 hover:text-accent transition-colors">Giveaway Rules (US)</Link></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white border-t border-gray-200">
        <div className="container-main py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              {/* TikTok */}
              {/* TODO: confirm social URLs */}
              <Link href="https://www.tiktok.com/@valuebox" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-600 transition-colors">
              ...
              {/* Instagram */}
              {/* TODO: confirm social URLs */}
              <Link href="https://www.instagram.com/valuebox" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-600 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* LinkedIn */}
              {/* TODO: confirm social URLs */}
              <Link href="https://www.linkedin.com/company/valuebox" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-600 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-6 pt-4 border-t border-gray-100">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4 text-xs text-gray-400">
                <Link href="/support" className="hover:text-gray-600 transition-colors">Cookie Settings</Link>
                <Link href="/support" className="hover:text-gray-600 transition-colors">Privacy Policy</Link>
                <Link href="/support" className="hover:text-gray-600 transition-colors">Terms of Service</Link>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 text-center">
            ...
            <p className="text-xs text-gray-400 mt-2">&copy; ValueBox Ltd. 2026</p>
          </div>
        </div>
      </div>
    </footer>
