    ...
    <div className="flex items-start gap-4 py-4 border-b border-gray-100 last:border-0">
      ...
      <div className="flex items-center border border-gray-200 rounded-lg shrink-0">
        <button
          ...
          disabled={isLoading}
          className="px-2.5 py-1.5 text-gray-500 hover:text-gray-700 disabled:opacity-50 text-sm"
        >
          −
        </button>
        <span className="px-3 py-1.5 text-sm font-medium border-x border-gray-200 min-w-[2rem] text-center">
          {item.quantity}
        </span>
        <button
      ...
      <button
        ...
        disabled={isLoading}
        className="text-gray-300 hover:text-gray-500 disabled:opacity-50 shrink-0"
      >
